...
<div region="center" style="padding:0px;border:0px">
	<t:datagrid name="functionList" title="menu.manage" actionUrl="functionController.do?functionGrid" idField="id" treegrid="true" pagination="false">
        ...
        <t:dgFunOpt funname="exportMenu(id)" title="导出菜单" urlclass="ace_button" urlfont="fa-database"></t:dgFunOpt>
        <t:dgFunOpt funname="ImportXls(id)" title="导入菜单" urlclass="ace_button" urlStyle="background-color:#1a7bb9;" urlfont="fa-database"></t:dgFunOpt>
...
function exportMenu(id){
	$("#myfrm").attr('src','functionMenuController.do?exportFunctionMenus&id='+id);  
}
function ImportXls(id) {
	openuploadwin('菜单导入', 'functionMenuController.do?upload&id='+id, "functionList");
}
</script>
<iframe style="width:0;height:0;border:0" src="#" id="myfrm" id="myfrm"></iframe>
